...
1. Исследуйте однородный пуассоновский процесс на дифференцируемость (с.к. и по вероятности, по распределению)
...
3. Вычислить интеграл $$I = \int_0^T W(t) dW(t)$$ как с.к. предел сумм при равномерном разбиении, если:
    - в качестве точки выбирается левая точка отрезка
    - выбирается средняя точка отрезка