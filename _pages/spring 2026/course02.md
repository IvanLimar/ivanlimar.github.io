...
toc: true
toc_sticky: true
permalink: /for-students/spring2026/aistat/
sidebar:
  nav: "docs"
classes: wide
---
...
# Условия РГР/Лаб.
 ...
 - [Первая](https://drive.google.com/file/d/1wG8zMO6GuTSTsSqp7nxJ-ctkIpfO0Phk/view)
 - [Вторая](https://drive.google.com/file/d/1-rDXaxlOmvL4RSZUhQMeMoZUg1U5ugI6/view)
 - [Третья](https://drive.google.com/file/d/17LX53bn7rEDPXbKUc4Ac9AzKk76fNmE-/view)
 - [Четвёртая](https://drive.google.com/file/d/1Rj2pwPkoB5jBmupwAQXBuvedYWLHtY2T/view)
 - [Пятая](https://drive.google.com/file/d/1DCtg_w2Zg8DuG_N-HcoCo2N0jGytGUsA/view)
...
3. Биномиальное
4. Распределение Коши $$\mathrm{Cauchy}(x_0, 1)$$ (тут нужно подумать)
...
(или хотя бы написать формулу, по которым это считается). Кроме того, найдите информацию Фишера для регулярных моделей (плюс подумать как регуляроность можно показать). Какими свойствами
обладают найденные оценки?
1. Пуассон
2. Геометрическое
...
8. Среди 2025 семей, имеющих двух детей, 529 семей с двумя мальчиками, 477 семей
...
9. Есть два потока абитуриентов по 300 человек в каждом. В первом потоке
...
10. В предыдущей задаче сгруппировать данные по успешно сдавшим экзамен (оценка
больше 2) и *завалившим*. Можно ли считать первый поток более *сильным*?
11. 246 человек привились и не заболели х., трое привились и заболели, 473 не
...
12. Тот же датасет. Можно ли считать,
