...
9. В квадрат длина стороны которого равняется единице случайно бросается точка.
С какой вероятностью расстояние от точки до ближайшей вершины не превосходит данного
$$x$$?