...
- Четвертая:
    - Описание модели линейной регрессии. *Минимальные* и *обычные* предположения
    на вектор ошибок
    - Метод наименьших квадратов. Свойства оценки метода наименьших квадратов
    при *минимальных* (теорема Гаусса-Маркова) и *обычных* предположениях
    - Основная теорема о регрессии
    - t-критерий
    - F-критерий
    - Однофакторный дисперсионный анализ. Что проверяет? Межгрупповая и внутригрупповая
    дисперсии
